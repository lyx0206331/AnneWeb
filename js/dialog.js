...
var SimplePop = {
    alert: function (msg, arg) {
        var alertDefaults = {
            popType: "alert",
            title: "鎻愮ず",
            content: "<div class='layer_msg'><p>" + (msg === undefined ? "" : msg) + "</p><button id='simplePopBtnSure' type='button'>纭畾</button></div>",
            callback: function () {
    ...
    confirm: function (msg, arg) {
        var confirmDefaults = {
            popType: "confirm",
            title: "璇烽€夋嫨",
            content: "<div class='layer_msg'><p>" + (msg === undefined ? "" : msg) + "</p><button id='simplePopBtnSure' type='button'>纭畾</button><button id='SimplePopBtncancel' type='button'>鍙栨秷</button></div>",
            cancel: function () {
    ...
    prompt: function (msg, arg) {
        var promptDefaults = {
            popType: "prompt",
            title: "标题",
            content: "<div class='layer_msg'><p>" + (msg === undefined ? "" : msg) + "</p><div><input type='text' style='background: #eaeaea;'/></div><button id='simplePopBtnSure' type='button'>确定</button><button id='SimplePopBtncancel' type='button'>取消</button></div>",
            cancel: function () {
